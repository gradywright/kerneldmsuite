function x = sphHammersleyNodes(N)
%SPHHAMMERSLEYNODES Comutes a set of Hammersley nodes on the unit sphere,
%   which are low-discrepancy sequences of nodes.
%
%   X = sphHammersleyNodes(N) returns an N-by-3 matrix of Hammersley nodes
